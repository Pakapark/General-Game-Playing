...
public class MachineState {
    ...
    public MachineState parent = null;
    public List<MachineState> children = new ArrayList<MachineState>();
    public List<Move> moves = new ArrayList<Move>();
//    public HashMap<MachineState, Move> childToMove = new HashMap<MachineState, Move>();
