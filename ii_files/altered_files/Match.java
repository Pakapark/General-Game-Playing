...
public class Match
{
    ...
    protected static final String renderArrayAsJSON(List<?> theList, boolean useQuotes) {
        String s = "[";
    ...
    protected static final List<String> renderStateHistory(List<Set<GdlSentence>> stateHistory) {
    ...
    protected static final List<String> renderMoveHistory(List<List<GdlTerm>> moveHistory) {
    ...
    protected static final List<String> renderErrorHistory(List<List<String>> errorHistory) {
    ...
    protected static final String renderLeafXML(String tagName, Object value) {
    	return "<" + tagName + ">" + value.toString() + "</" + tagName + ">";
    }

    protected static final String renderMoveHistoryXML(List<List<GdlTerm>> moveHistory) {
    	StringBuilder theXML = new StringBuilder();
    ...
    protected static final String renderErrorHistoryXML(List<List<String>> errorHistory) {
    	StringBuilder theXML = new StringBuilder();
    ...
    protected static final String renderStateHistoryXML(List<Set<GdlSentence>> stateHistory) {
    	StringBuilder theXML = new StringBuilder();
    ...
    protected static final String renderArrayXML(String tag, JSONArray arr) throws JSONException {
    	StringBuilder theXML = new StringBuilder();
    ...
    protected static final String renderGdlToXML(Gdl gdl) {
        String rval = "";
    ...
    protected List<Boolean> getIsPlayerHuman() {
    	return this.isPlayerHuman;
    }

    protected EncodedKeyPair getCryptographicKeys() {
    	return theCryptographicKeys;
    }
}